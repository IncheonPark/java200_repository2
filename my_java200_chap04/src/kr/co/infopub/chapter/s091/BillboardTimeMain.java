	  ...
	  public static void main(String[] args) {
		  ...
		  try {
			  ...
			  if (entity != null) { //결과가 있다면 결과에서 한 줄씩
				  String result = EntityUtils.toString(entity); //toString 실행
				  sb.append(result); //버퍼에 한 줄씩 저장
			  }
			  
			  doc = Jsoup.parse(sb.toString()); //전체 내용을 HTML 파싱
			  String id = "charts";
			  // <div id="charts" data-chart-date="yyyy-MM-dd"
			  Element eid = doc.getElementById(id); // id가 "charts"인 요소를 찾음
